...
<head>
	...
	<title>MDKT Car Booking System |  Kemas kini Imej 4</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Imej 4 </h2>
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Imej 4</div>
...
<label class="col-sm-4 control-label">Imej 4 terkini</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage4 from vehicles where vehicles.vehicleid=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Muat naik Imej 4 baharu<span style="color:red">*</span></label>
												<div class="col-sm-8">
